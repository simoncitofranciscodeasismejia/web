...
<div class="card-content table-responsive" style="overflow-x: hidden; height: 60vh;">
    ...
    <form method="POST" class="">
        ...
        <div class="row text-center">
            <!-- <div class="col">
                <label for="periodo" class="text-end">Seleccione periodo:</label>
            </div> -->
            <!-- <div class="col">
                <select name="periodo" id="periodo" class="form-control">
                    <?php
                        ...
                        // $stmt->execute();
                        // ?><option value="" disabled selected>Periodo</option><?php
...
if (isset($_POST['grado']) && isset($_POST['seccion'])) {
    ...
    $query = $connect->prepare("SELECT teachers.nomte, students.nomstu, students.idstu, students.dnist, students.apestu
                                 FROM teachers 
                                 INNER JOIN seccion ON teachers.dnite = seccion.idtea 
                ...
                <div class="modal-content">
                    ...
                    ?>
                        ...
                        <div class="form-row">
                            <div class="col-sm-6">
                            <div class="form-group">
                                    <label for="modal_contact_lastname">Cedula del profesor asignado</label>
                                    <div class="input-group">
                                        <input type="text" name="dnite" id="dnite" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
...
if(isset($_POST['agregar']))
{
    ...
    // $capa = $_POST['capa'];
        ...
        $statement = $connect->prepare("INSERT INTO seccion (nomsec,idsub,idper,state, idtea) VALUES ('$nomsec','$grado','$periodo','Activo', $dnite)");
