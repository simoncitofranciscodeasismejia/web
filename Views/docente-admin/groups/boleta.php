...
<div class="wrapper">
    ...
    <div id="content">
            ...
            <div class="row">
                <div class="col-md-12 card">
                    ...
                    <?php
                            // Muestra los resultados
                                foreach ($student as $est) { 
                                    ...
                                    foreach($secc as $sec){
                                        ...
                                        $query2 = "SELECT * FROM teachers WHERE idtea = $idtea";
                        ...
                        <h2 class="ml-lg-2">creacion del boletin de <?php echo $apellido . ' ' . $nombre;?></h2>
                    </div>

                    <form method="post" action="registrarboleta.php" id="">
                        <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="languagearts">Lenguaje y Comunicación:</label>
                                <select id="languagearts" class="form-control" name="languagearts" required>
                            ...
                            <div class="col">
                                <label for="mathematics">Matemáticas:</label>
                                <select id="mathematics" class="form-control"  name="mathematics" required>
                                <option value="">Selecciona la calificación</option>
                                <option value="A">A</option>
                                <option value="B">B</option>
                                <option value="C">C</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="art">Expresion artistica:</label>
                                <select id="art" class="form-control" name="art" required>
                                <option value="">Selecciona la calificación</option>
                                <option value="A">A</option>
                                <option value="B">B</option>
                                <option value="C">C</option>
                            ...
                            <div class="col">
                                <label for="educFisica">Educacion fisica:</label>
                                <select id="educFisica" class="form-control"  name="educFisica" required>
                                <option value="">Selecciona la calificación</option>
                                <option value="A">A</option>
                                <option value="B">B</option>
                                <option value="C">C</option>
                            ...
                            <div class="col">
                                ...
                                <select id="aprobacion" class="form-control"  name="aprobacion" required>
                                <option value="">Selecciona la calificación</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="educFisica">Observaciones:</label>
                                <textarea name="observaciones" id="observaciones" class="form-control"></textarea>
                            </div>
                        </div>
                        <br>
                        <button type="submit" name="enviar" class="btn btn-primary  btn-block">Guardar Boletín</button>
                        <br>
                    </form>
                <?php } ?>
                </div>
        ...
        <div style="text-align: center; background-color: #d6d6f0; overflow: hidden; padding: 10px;">
