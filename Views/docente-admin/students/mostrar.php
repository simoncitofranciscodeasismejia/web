...
logout</span>Cerrar sesión</a>
           ...
           <!--------main-content------------->
                ...
                $productosPorPagina = 5;
                    ...
                    <tbody>
                        <?php foreach($productos as $producto){ ?>
                            ...
                            <td><?php echo $producto->apestu ?></td>
            ...
            <td>
                <a href="mostrar_estudiante.php?idstu=<?php echo $producto->idstu; ?>" class='btn btn-success text-white'>
                ...
                <div id="step1"> 
                    ...
                    <div class="form-row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text"  name="txtdnis" maxlength="10" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required class="form-control" placeholder="Cédula Escolar" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <button id="btnEndStep1">Siguiente</button>
                </div>
...
<?php  
 ...
 if(isset($_POST['agregar']))
 {
  ...
  if(!isset($errMSG))
  {
   $stmt = $connect->prepare("INSERT INTO students(dnist, nomstu, edast, direce,sexes,fenac,foto, state,rol,nomfa,st) VALUES(:dnist, :nomstu,:edast,:direce,:sexes,:fenac,:foto, 'Activo','','', '1')");
...
SET `dnist`= :dnist, `nomstu` = :nomstu, `edast` = :edast, `direce` = :direce, `sexes` = :sexes,`fenac` = :fenac, `state` = :state WHERE `idstu` = :idstu";
$sql = $connect->prepare($consulta);
