...
$this->Cell(40, 8, utf8_decode('Listado de grado académicos'));
...
$pdf->Cell(50, 12, utf8_decode('Periodo'),1,0,'C',1);
$pdf->Cell(120, 12, utf8_decode('Grado'),1,1,'C',1);
...
$pdf->Cell(20, 8, utf8_decode($row['iddeg']),'B',0,'C',1);
$pdf->Cell(50, 8, utf8_decode($row['numperi']),'B',0,'C',1);
$pdf->Cell(120, 8, utf8_decode($row['nomgra']),'B',1,'C',1);
