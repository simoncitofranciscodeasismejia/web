  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	  <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1">
        <title>Periodo Escolar | Centro de Educación Inicial Simoncito Francisco de Asis Mejia</title>
	    <!-- Bootstrap CSS -->
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <i class="fa fa-user mr-1"></i>Nuevo periodo escolar
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="modal_contact_firstname">Periodo nro.</label>
                                    <div class="input-group">
                                       
                                        <input type="text"  name="txtperi" required class="form-control" placeholder="" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="txtnom" required class="form-control" placeholder="" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
...
$sql = "INSERT INTO period (numperi, starperi, endperi, nomperi) VALUES (:numperi, :starperi,:endperi,:nomperi)";
